...
#-------------------------------------------------------------------------
function Ensemble_Problem(configuration::Configuration{N,M,T}, initial_data::AbstractMatrix)  where {N,M,T<:Union{Float32,Float64}} 
...
function _Ensemble_Problem(configuration::Configuration{N,M,T}, ::GeodesicEquationsVacuum, initial_data::AbstractMatrix) where {N,M,T<:Union{Float32,Float64}}
...
function _Ensemble_Problem(configuration::Configuration{N,M,T}, ::ParallelTransportEquationsVacuum, initial_data::AbstractMatrix) where {N,M,T<:Union{Float32,Float64}}
    (; u0, p, tspan) = configuration
